...
int main()
{
    ...
    if (v_f.capacity() == v_s.capacity())
        std::cout << "\033[32m"
                  << "capacity = ok 👍" << std::endl;
    else
        std::cout << "\033[31m"
                  << "capacity = ko ❌" << std::endl;
...
{
    std::cout << "\033[31m"
              << "----------------- range input iterator  tests----------------" << std::endl;
    {
        ...
        std::cout << "\033[33m"
                  << "range constructor  test :" << std::endl;
...
{
    std::cout << "\033[31m"
              << "-----------------iterator comparison tests----------------" << std::endl;
    {
        ft::vector<int> a;
...
{
    std::cout << "\033[31m"
              << "-----------------reverse_iterator comparison tests----------------" << std::endl;
    {
        ft::vector<int> a;
        for (int i = 0; i < 1000; i++)
        {
